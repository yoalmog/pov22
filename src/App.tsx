...
export default function App() {
  ...
  const [activeBleId, setActiveBleId] = useState<string | null>(() => safeGetLocal("holospin_ble_device_id") || null);
  ...
  const handleBluetoothConnect = async () => {
    try {
      ...
      const foundId = await scanAndConnect();
      // Save the device ID so it persists for reconnects and command routing
      setActiveBleId(foundId);
      safeSaveLocal("holospin_ble_device_id", foundId);
      setToastMessage("✅ חיבור בלוטות' הצליח! / Bluetooth connected!");
    } catch (err: any) {
  ...
  const handleDownloadLogs = async () => {
    try {
      ...
      setToastMessage("שגיאה בהורדת לוגים: וודא חיבור למכשיר / Error: Could not download logs from device");
    }
  };
    ...
    <div id="tour-sync-group" className="flex items-center gap-1.5 min-[380px]:gap-2 sm:gap-3 select-none">
      ...
      <div className="flex items-center gap-0.5 min-[380px]:gap-1 bg-slate-900/60 border border-slate-800 rounded-full p-0.5 h-7 min-[380px]:h-8 backdrop-blur-md shadow-inner">
        ...
        <button
          ...
          className={`w-6 h-6 min-[380px]:w-7 min-[380px]:h-7 rounded-full flex items-center justify-center transition-all duration-300 relative ${isSyncEnabled
        ...
        <button
          ...
          className={`w-6 h-6 min-[380px]:w-7 min-[380px]:h-7 rounded-full flex items-center justify-center transition-all duration-300 relative ${isBluetoothConnected
        ...
        {isConnected ? (
          ...
          <button
            ...
            disabled={isRetrying}
            className={`w-6 h-6 min-[380px]:w-7 min-[380px]:h-7 rounded-full flex items-center justify-center transition-all duration-300 relative ${isRetrying
                      ...
                      <div className="flex items-center gap-4 w-full">
                        ...
                        <div className="relative shrink-0">
                          ...
                          <div className={`w-12 h-12 rounded-xl bg-slate-900 border flex items-center justify-center shadow-inner transition overflow-hidden relative ${isPresetActive ? 'border-[#00b4d8] shadow-[0_0_15px_rgba(0,180,216,0.2)]' : 'border-slate-800 group-hover:border-slate-700'}`}>
                            {saved ? (
                              <motion.div
                                className={`scale-75 flex items-center justify-center ${saved.activeEffect === 'rainbow' || saved.activeEffect === 'acid' ? 'animate-rainbow-shift' :
    ...
    return (
      <div className="px-5 pt-2 pb-28 flex flex-col gap-6 ">
        ...
        <div className="border border-slate-800/80 rounded-2xl bg-[#0c0e15] p-5 flex flex-col gap-4 mt-2">
            ...
            <div className="grid grid-cols-3 gap-2">
              {[
                ...
                <button
                  ...
                  className={`flex flex-col items-center justify-center p-3 rounded-xl border transition cursor-pointer ${selectedSimModel === m.id
          ...
          <button
            onClick={() => runHandshakeFlow()}
            disabled={isHandshaking}
            className={`w-full py-4 rounded-xl text-[11px] font-bold tracking-widest uppercase transition flex items-center justify-center gap-2 cursor-pointer ${isHandshaking
      ...
      <div className="px-5 pt-2 pb-28 flex flex-col gap-6 ">
          ...
          <div className="flex gap-2 p-1 bg-slate-950/50 rounded-2xl border border-slate-800/40">
            {[
              ...
              <button
                ...
                className={`flex-1 py-2 rounded-xl text-[8px] font-bold uppercase tracking-widest transition-all ${gestureSensitivity === prof.val
        ...
        <div className={`p-5 rounded-3xl border flex flex-col gap-4 transition-all duration-300 ${handInFrame ? 'bg-emerald-500/10 border-emerald-500/30' : 'bg-slate-900/40 border-slate-800/60'}`}>
          ...
          <button
            ...
            className={`w-full py-2.5 rounded-xl border font-bold text-[9px] uppercase tracking-widest transition-all flex items-center justify-center gap-2 ${handInFrame
        ...
        <div className="flex flex-col gap-3">
          {[
            ...
            return (
              <div key={ges.key} className={`relative bg-[#0c0e15] border rounded-2xl p-4 flex flex-col gap-4 overflow-hidden transition-all duration-300 ${isActive ? 'border-[#00b4d8] shadow-[0_0_20px_rgba(0,180,216,0.3)] scale-[1.02]' : 'border-slate-800'
                }`}>
                {isActive && <div className="absolute inset-0 bg-[#00b4d8]/10 animate-pulse pointer-events-none" />}

                <div className="flex items-center justify-between relative z-10">
                  <div className="flex items-center gap-3">
                    <div className={`p-2.5 rounded-xl border transition-all duration-300 ${isActive ? 'bg-[#00b4d8]/20 border-[#00b4d8] text-white shadow-[0_0_10px_rgba(0,180,216,0.4)] text-[#00b4d8]' : 'bg-slate-900 border-slate-800 text-[#00b4d8]'
                      }`}>
                ...
                <div className="flex flex-col gap-1.5 relative z-10">
                  ...
                  <select
                    ...
                    className={`w-full bg-[#050608] border rounded-xl px-4 py-3 text-xs text-slate-200 focus:outline-none appearance-none cursor-pointer transition-colors ${isActive ? 'border-[#00b4d8]/50 focus:border-[#00b4d8]' : 'border-slate-800 focus:border-[#00b4d8]/50'
                      }`}
                  >
  ...
  if (subPage === "background") {
    return (
      <div className="px-5 pt-2 pb-28 flex flex-col gap-6 ">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div
            className={`relative h-28 rounded-2xl border-2 overflow-hidden cursor-pointer flex flex-col justify-end p-4 transition-all ${bgImageId === "galaxy0" ? "border-[#2dd4bf] shadow-[0_0_20px_rgba(45,212,191,0.2)]" : "border-slate-800"
              }`}
          ...
          <div
            className={`relative h-28 rounded-2xl border-2 overflow-hidden cursor-pointer flex flex-col justify-end p-4 transition-all ${bgImageId === "galaxy1" ? "border-[#2dd4bf] shadow-[0_0_20px_rgba(45,212,191,0.2)]" : "border-slate-800"
              }`}
          ...
          <div
            className={`relative h-28 rounded-2xl border-2 overflow-hidden cursor-pointer flex flex-col justify-end p-4 transition-all ${bgImageId === "galaxy2" ? "border-[#a855f7] shadow-[0_0_20px_rgba(168,85,247,0.2)]" : "border-slate-800"
              }`}
          ...
          <div
            className={`relative h-28 rounded-2xl border-2 overflow-hidden cursor-pointer flex flex-col justify-end p-4 transition-all ${bgImageId === "galaxy3" ? "border-[#f97316] shadow-[0_0_20px_rgba(249,115,22,0.2)]" : "border-slate-800"
              }`}
          ...
          <div
            className={`relative h-28 rounded-2xl border-2 overflow-hidden cursor-pointer flex flex-col justify-end p-4 transition-all ${bgImageId === "butterfly" ? "border-[#f472b6] shadow-[0_0_20px_rgba(244,114,182,0.2)]" : "border-slate-800"
              }`}
          ...
          <div
            className={`relative h-28 rounded-2xl border-2 overflow-hidden cursor-pointer flex flex-col justify-end p-4 transition-all ${bgImageId === "planet" ? "border-[#fbbf24] shadow-[0_0_20px_rgba(251,191,36,0.2)]" : "border-slate-800"
              }`}
          ...
          <div
            className={`relative h-28 rounded-2xl border-2 overflow-hidden cursor-pointer flex flex-col justify-end p-4 transition-all ${bgImageId === "spaceDark" ? "border-slate-400 shadow-[0_0_20px_rgba(255,255,255,0.1)]" : "border-slate-800"
              }`}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div
            className={`relative h-28 rounded-2xl border-2 overflow-hidden cursor-pointer flex flex-col justify-end p-4 transition-all ${bgImageId === "video1" ? "border-[#3b82f6] shadow-[0_0_20px_rgba(59,130,246,0.2)]" : "border-slate-800"
              }`}
          ...
          <div
            className={`relative h-28 rounded-2xl border-2 overflow-hidden cursor-pointer flex flex-col justify-end p-4 transition-all ${bgImageId === "video2" ? "border-[#ec4899] shadow-[0_0_20px_rgba(236,72,153,0.2)]" : "border-slate-800"
              }`}
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="grid grid-cols-4 gap-2">
                <button
                  ...
                  className={`py-2 px-1 rounded-xl border text-[10px] font-bold flex flex-col items-center justify-center gap-1 transition-all ${logoUrl === planetImg ? "border-[#00b4d8] bg-[#00b4d8]/15" : "border-slate-800 bg-slate-900/40 hover:bg-slate-800"
                    }`}
                >
                ...
                <button
                  ...
                  className={`py-2 px-1 rounded-xl border text-[10px] font-bold flex flex-col items-center justify-center gap-1 transition-all ${logoUrl === "preset:smile" ? "border-[#00b4d8] bg-[#00b4d8]/15" : "border-slate-800 bg-slate-900/40 hover:bg-slate-800"
                    }`}
                >
                ...
                <button
                  ...
                  className={`py-2 px-1 rounded-xl border text-[10px] font-bold flex flex-col items-center justify-center gap-1 transition-all ${logoUrl === "preset:ghost" ? "border-[#00b4d8] bg-[#00b4d8]/15" : "border-slate-800 bg-slate-900/40 hover:bg-slate-800"
                    }`}
                >
                ...
                <button
                  ...
                  className={`py-2 px-1 rounded-xl border text-[10px] font-bold flex flex-col items-center justify-center gap-1 transition-all ${logoUrl === "preset:aperture" ? "border-[#00b4d8] bg-[#00b4d8]/15" : "border-slate-800 bg-slate-900/40 hover:bg-slate-800"
                    }`}
                >
              ...
              <div className="grid grid-cols-2 gap-2">
                {VIDEO_PRESETS.map((preset) => (
                  <button
                    ...
                    className={`py-2.5 px-3 rounded-xl border text-[10px] font-bold tracking-wider transition-all flex flex-col items-center justify-center text-center gap-1 cursor-pointer ${synthVideoUrl === preset.url
      ...
      <div className="flex-1 overflow-y-auto px-5 pb-28 pt-2 flex flex-col gap-6 ">
        ...
        <div className="w-full max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center my-8">
          <div className="flex justify-center items-center w-full max-w-[280px] aspect-square mx-auto relative">
            <motion.div
              id="tour-simulator"
              className={`w-full h-full rounded-full border-[2px] bg-[#050608] flex items-center justify-center overflow-hidden relative transition-all duration-500 ${activeEffect === "fire"
        ...
        <div className="flex justify-center -mt-4 mb-4">
          <button
            ...
            className={`flex items-center gap-3 px-6 py-4 rounded-2xl border transition-all active:scale-95 ${gestureMode
          ...
          <div className="grid grid-cols-4 gap-3 bg-[#0c0e15]/80 p-4 rounded-3xl border border-slate-800/50">
            {EFFECTS.map((eff) => (
              <button
                ...
                className={`flex flex-col items-center justify-center py-3 px-1 rounded-2xl border transition-all duration-300 ${activeEffect === eff.id
                    ? (eff.id === "fire"
...
return (
  <div className={`bg-transparent min-h-screen text-text-primary font-sans w-full max-w-md mx-auto shadow-2xl relative overflow-x-hidden flex flex-col antialiased transition-all duration-500`}
    ...
    {toastMessage && (
      <div className={`fixed bottom-24 left-1/2 -translate-x-1/2 w-[90%] max-w-[350px] z-[1000] bg-[#0c0e15]/95 border px-4 py-3 rounded-xl text-xs font-bold tracking-wider uppercase animate-in fade-in slide-in-from-bottom-5 duration-300 flex items-start gap-3 ${toastMessage.toLowerCase().includes("error") ||
    ...
    <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md border-t border-slate-800/40 bg-[#090a10]/90 backdrop-blur-md flex justify-between items-center px-3 min-[360px]:px-5 sm:px-6 py-2.5 min-[360px]:py-3 pb-5 min-[360px]:pb-6 z-50 shadow-[0_-8px_30px_rgba(0,0,0,0.6)]">
      ...
      >
        <SlidersHorizontal
          className={`w-4.5 h-4.5 min-[360px]:w-5.5 min-[360px]:h-5.5 transition-all duration-300 ${activeTab === "controller"
              ? "text-[#00b4d8] scale-110 drop-shadow-[0_0_8px_rgba(0,180,216,0.5)]"
              : "text-slate-500 group-hover:text-slate-300"
            }`}
        />
        <span
          className={`text-[7px] min-[360px]:text-[8px] min-[400px]:text-[9px] font-black tracking-wider min-[360px]:tracking-widest transition-colors duration-300 ${activeTab === "controller" ? "text-[#00b4d8]" : "text-slate-500"
            }`}
        >
          CONTROLLER
        </span>
        <div className={`w-0.75 h-0.75 min-[360px]:w-1 min-[360px]:h-1 rounded-full bg-[#00b4d8] shadow-[0_0_6px_#00b4d8] transition-all duration-300 mt-0.5 ${activeTab === "controller" ? "scale-100 opacity-100" : "scale-0 opacity-0"
          }`} />
      </button>
      <button
        onClick={() => {
      ...
      >
        <Aperture
          className={`w-4.5 h-4.5 min-[360px]:w-5.5 min-[360px]:h-5.5 transition-all duration-300 ${activeTab === "effects"
              ? "text-[#00b4d8] scale-110 drop-shadow-[0_0_8px_rgba(0,180,216,0.5)] animate-spin-slow"
              : "text-slate-500 group-hover:text-slate-300"
            }`}
        />
        <span
          className={`text-[7px] min-[360px]:text-[8px] min-[400px]:text-[9px] font-black tracking-wider min-[360px]:tracking-widest transition-colors duration-300 ${activeTab === "effects" ? "text-[#00b4d8]" : "text-slate-500"
            }`}
        >
          EFFECTS
        </span>
        <div className={`w-0.75 h-0.75 min-[360px]:w-1 min-[360px]:h-1 rounded-full bg-[#00b4d8] shadow-[0_0_6px_#00b4d8] transition-all duration-300 mt-0.5 ${activeTab === "effects" ? "scale-100 opacity-100" : "scale-0 opacity-0"
          }`} />
      </button>
      <button
        onClick={() => {
      ...
      >
        <Wand2
          className={`w-4.5 h-4.5 min-[360px]:w-5.5 min-[360px]:h-5.5 transition-all duration-300 ${activeTab === "studio"
              ? "text-[#00b4d8] scale-110 drop-shadow-[0_0_8px_rgba(0,180,216,0.5)]"
              : "text-slate-500 group-hover:text-slate-300"
            }`}
        />
        <span
          className={`text-[7px] min-[360px]:text-[8px] min-[400px]:text-[9px] font-black tracking-wider min-[360px]:tracking-widest transition-colors duration-300 ${activeTab === "studio" ? "text-[#00b4d8]" : "text-slate-500"
            }`}
        >
          STUDIO
        </span>
        <div className={`w-0.75 h-0.75 min-[360px]:w-1 min-[360px]:h-1 rounded-full bg-[#00b4d8] shadow-[0_0_6px_#00b4d8] transition-all duration-300 mt-0.5 ${activeTab === "studio" ? "scale-100 opacity-100" : "scale-0 opacity-0"
          }`} />
      </button>
      <button
        onClick={() => {
      ...
      >
        <Settings
          className={`w-4.5 h-4.5 min-[360px]:w-5.5 min-[360px]:h-5.5 transition-all duration-300 ${activeTab === "settings"
              ? "text-[#00b4d8] scale-110 drop-shadow-[0_0_8px_rgba(0,180,216,0.5)]"
              : "text-slate-500 group-hover:text-slate-300"
            }`}
        />
        <span
          className={`text-[7px] min-[360px]:text-[8px] min-[400px]:text-[9px] font-black tracking-wider min-[360px]:tracking-widest transition-colors duration-300 ${activeTab === "settings" ? "text-[#00b4d8]" : "text-slate-500"
            }`}
        >
          SETTINGS
        </span>
        <div className={`w-0.75 h-0.75 min-[360px]:w-1 min-[360px]:h-1 rounded-full bg-[#00b4d8] shadow-[0_0_6px_#00b4d8] transition-all duration-300 mt-0.5 ${activeTab === "settings" ? "scale-100 opacity-100" : "scale-0 opacity-0"
          }`} />
      </button>
    </nav>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex gap-1.5 items-center">
                    {tutorialSteps.map((_, i) => (
                      <div
                        key={i}
                        className={`h-1.5 rounded-full transition-all duration-300 ${i === tutorialStep ? 'w-4 bg-[#00b4d8]' : 'w-1.5 bg-slate-700'
                          }`}
                      />
                    ))}
                  </div>
