...
export const AppWalkthrough: React.FC<AppWalkthroughProps> = ({
  ...
  const steps: TourStep[] = [
    ...
    } as any,
    {
      ...
      title: "POV Hologram Previewer",
      titleHe: "מציג הולוגרמת POV",
      description: "This real-time interactive previewer visualizes the active POV pattern, rotation velocity, text animations, and image tinting. Watch it spin in real-time as you tweak values!",
      descriptionHe: "מציג אינטראקטיבי המראה בזמן אמת את דפוסי ה-POV, מהירות הסיבוב, אנימציות הטקסט ושינויי הצבעים. צפו בו מסתובב בזמן אמת כשאתם משנים ערכים!",
      tab: "controller",
      subPage: null,
    },
    {
